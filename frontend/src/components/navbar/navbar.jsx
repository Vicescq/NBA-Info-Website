...
function Navbar({homedata, control_eyenavitem_state}){
    ...
    <ul className="navlist">
        ...
        {homedata ? <EyeNavItem itemprops={eyeprops} homedata={homedata} control_eyenavitem_state={control_eyenavitem_state}/> : null}
